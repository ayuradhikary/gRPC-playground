package org.ayur.sec10.validator;
...
public class RequestValidator {
    ...
    private static Metadata toMetadata(ValidationCode code) {
        ...
        ErrorMessage errorMessage = ErrorMessage.newBuilder().setValidationCode(code).build();
//        var key = Metadata.Key.of("some desc", Metadata.ASCII_STRING_MARSHALLER);
//        metadata.put(key, code.toString()); for descriptive message with key i.e with string
