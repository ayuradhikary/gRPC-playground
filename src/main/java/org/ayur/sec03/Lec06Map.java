...
import com.ayur.models.sec03.BodyStyle;
import com.ayur.models.sec03.Car;
import com.ayur.models.sec03.Dealer;
...
public class Lec06Map {
    ...
    public static void main(String[] args) {
        var car1 = Car.newBuilder().setMake("honda").setModel("civic").setYear(2000).setBodyStyle(BodyStyle.COUPE).build();

        var car2 = Car.newBuilder().setMake("honda").setModel("accord").setYear(2002).setBodyStyle(BodyStyle.SEDAN).build();
