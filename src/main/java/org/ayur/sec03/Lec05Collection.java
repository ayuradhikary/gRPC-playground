...
import com.ayur.models.sec03.Book;
import com.ayur.models.sec03.Library;
...
public class Lec05Collection {
    ...
    public static void main(String[] args) {
        ...
        //create books
        var book1 = Book.newBuilder().setTitle("harry potter - part 1").setAuthor("J.K. Rowling").setPublicationYear(1997).build();
        ...
        //create Library
        var library = Library.newBuilder().setName("fantasy library")
//                .addBooks(book1)
//                .addBooks(book2)
//                .addBooks(book3)
        ...
        log.info("books {}",library.getBooksList());
