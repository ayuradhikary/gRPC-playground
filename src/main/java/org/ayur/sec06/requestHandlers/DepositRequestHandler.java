package org.ayur.sec06.requestHandlers;
...
public class DepositRequestHandler implements StreamObserver<DepositRequest> {
    ...
    public void onCompleted() {
        AccountBalance accountBalance = AccountBalance.newBuilder().setAccountNumber(this.accountNumber).setBalance(AccountRepository.getBalance(this.accountNumber)).build();
